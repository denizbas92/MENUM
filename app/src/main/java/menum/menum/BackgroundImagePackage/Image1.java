...
import menum.menum.PersonnelPackage.AddPersonnel;
        ...
        databaseReference
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        try{
                            if(backGroundImagePost.getImage1().equalsIgnoreCase("")==false){
                                Glide.with(container.getContext()).load(backGroundImagePost.getImage1()).into(image1);
                            }
                        }catch (Exception e){
            ...
            public void onClick(View view) {
                databaseReference
                        ...
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                final BackGroundImagePost backGroundImagePost=dataSnapshot.getValue(BackGroundImagePost.class);
                                try{
                                    if(backGroundImagePost.getImage1().equalsIgnoreCase("")){
                                        ...
                                        StorageReference storageReference =
                                                FirebaseStorage.getInstance().
                                                        getReferenceFromUrl(backGroundImagePost.getImage1());
                                        storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                            @Override
                                            public void onSuccess(Void aVoid) {
                                                // File deleted successfully
                                                Log.e("firebasestorage", "onSuccess: deleted file");
                                                databaseReference.child(MenumConstant.STORE).child(phoneNumber).child(MenumConstant.BACKGROUND_IMAGES).child("image1").setValue("");
                                                ...
                                                if(backGroundImagePost.getImage2().equalsIgnoreCase("")==false){
                                                    databaseReference.child(MenumConstant.STORE).child(phoneNumber).child(MenumConstant.BACKGROUND_IMAGES).child("image1").setValue(backGroundImagePost.getImage2());
                                                    if(backGroundImagePost.getImage3().equalsIgnoreCase("")==false){
                                                        databaseReference.child(MenumConstant.STORE).child(phoneNumber).child(MenumConstant.BACKGROUND_IMAGES).child("image2").setValue(backGroundImagePost.getImage3());
                                                        ...
                                                        databaseReference.child(MenumConstant.STORE).child(phoneNumber).child(MenumConstant.BACKGROUND_IMAGES).child("image2").setValue("");
                                                    }
                                                }
        ...
        databaseReference
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        BackGroundImagePost backGroundImagePost=dataSnapshot.getValue(BackGroundImagePost.class);
                        try{
                            deleteOldImage(backGroundImagePost.getImage1(),index,progressDialog);
                        }catch (Exception e){
        ...
        try {
            ...
            filePath.putFile(getUri()).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if (index == 1) {
                        backGroundImagePost.setImage1(taskSnapshot.getDownloadUrl().toString());
                        databaseReference
                                .child(MenumConstant.STORE)
                                .child(phoneNumber)
                                .child(MenumConstant.BACKGROUND_IMAGES)
                                .child("image1").setValue(backGroundImagePost.getImage1());
                    }
                }
            });
        }catch (Exception e){
