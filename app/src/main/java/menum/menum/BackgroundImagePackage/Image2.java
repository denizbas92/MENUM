                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        try{
                            if(backGroundImagePost.getImage2().equalsIgnoreCase("")==false){
                                Glide.with(container.getContext()).load(backGroundImagePost.getImage2()).into(image2);
                            }
                        }catch (Exception e){
                ...
                databaseReference
                        ...
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                try{
                                    if(backGroundImagePost.getImage2().equalsIgnoreCase("")){
                                        ...
                                        StorageReference storageReference =
                                                FirebaseStorage.getInstance().
                                                        getReferenceFromUrl(backGroundImagePost.getImage2());
        ...
        databaseReference
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        BackGroundImagePost backGroundImagePost=dataSnapshot.getValue(BackGroundImagePost.class);
                        try{
                            deleteOldImage(backGroundImagePost.getImage2(),index,progressDialog);
                        }catch (Exception e){
        ...
        try {
            ...
            filePath.putFile(getUri()).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if (index == 1) {
                        backGroundImagePost.setImage2(taskSnapshot.getDownloadUrl().toString());
                        databaseReference
                                .child(MenumConstant.STORE)
                                .child(phoneNumber)
                                .child(MenumConstant.BACKGROUND_IMAGES)
                                .child("image2").setValue(backGroundImagePost.getImage2());
                    }
                }
            });
        }catch (Exception e){
