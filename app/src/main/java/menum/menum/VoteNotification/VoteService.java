...
import menum.menum.LikeNotification.LikeGetResult;
...
public class VoteService extends Service {
    ...
    private VoteGetResult voteGetResult=new VoteGetResult();

    private DatabaseReference databaseReference= FirebaseDatabase.getInstance().getReference();
    private static final  int ID=0005;
                                        ...
                                        .addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                try{
                                                    ...
                                                    new VoteGetResult(oldCounter,newCounter);
                                                    if(voteGetResult.isEqual()==1){
                                                        if(!netState){
                                                            if(notificationSettings.getCloseNotification().equalsIgnoreCase("false")){
                                                                ...
                                                                notBuilder.setContentText("Personelinize yeni oylar verildi !");
