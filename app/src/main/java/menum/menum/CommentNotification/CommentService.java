...
import menum.menum.AdviceNotification.AdviceGetResult;
...
public class CommentService extends Service {
    ...
    private CommentGetResult commentGetResult=new CommentGetResult();

    private DatabaseReference databaseReference= FirebaseDatabase.getInstance().getReference();
    private static final  int ID=0002;
                                        ...
                                        .addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                try{
                                                    ...
                                                    new CommentGetResult(oldCounter,newCounter);
                                                    if(commentGetResult.isEqual()==1){
                                                        if(!netState){
                                                            if(notificationSettings.getCloseNotification().equalsIgnoreCase("false")){
                                                                ...
                                                                notBuilder.setContentText("Menülerinize yeni yorumlar var !");
