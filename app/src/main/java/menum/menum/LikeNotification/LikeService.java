...
import menum.menum.CommentNotification.CommentGetResult;
...
public class LikeService extends Service {
    ...
    private LikeGetResult likeGetResult=new LikeGetResult();
                                        ...
                                        .addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                try{
                                                    ...
                                                    new LikeGetResult(oldCounter,newCounter);
                                                    if(likeGetResult.isEqual()==1){
                                                        if(!netState){
                                                            if(notificationSettings.getCloseNotification().equalsIgnoreCase("false")){
                                                                ...
                                                                notBuilder.setContentText("Menülerinize yeni beğeniler var !");
